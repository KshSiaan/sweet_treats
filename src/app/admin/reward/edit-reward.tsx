...
import { addRewards, editRewardById } from "@/lib/api/admin";
import { useRouter } from "next/navigation";
import { RewardType } from "@/types/admin";
...
export default function EditReward({ data }: { data: RewardType }) {
  ...
  const { mutate, isPending } = useMutation({
    mutationKey: ["edit_reward"],
    mutationFn: async (body: any) => {
      return editRewardById(token, data.id, body);
    },
    onError: (err: any) => {
